...
class DebugControllerWithMockedSource(DebugControllerForTesting):
    @endpoint
...
async def test_debug_with_pickle_by_value():
    ...
    with patch(
        ...
        # Spawn a special debug controller that knows how to retrieve the source code
        # for /tmp/monarch_test/class_closure.py and
        # /tmp/monarch_test/function_closure.py
        debug_controller = actor.get_or_spawn_controller(
            "debug_controller", DebugControllerWithMockedSource
        ).get()
