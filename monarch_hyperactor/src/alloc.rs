...
#[pyclass(
    ...
    module = "monarch.actor._extension.monarch_hyperactor.alloc",
    subclass
)]
...
pub struct PyRemoteProcessAllocInitializer {
    // instance of a Python subclass of `monarch.actor._extension.monarch_hyperactor.alloc.RemoteProcessAllocInitializer`.
    py_inner: Py<PyAny>,
