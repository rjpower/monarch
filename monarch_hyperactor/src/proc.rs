...
///        have a well defined module for these deps which needs to be monarch.actor._extension.monarch_hyperactor.proc and
...
#[pyclass(
    name = "Proc",
    module = "monarch.actor._extension.monarch_hyperactor.proc"
)]
pub struct PyProc {
...
pub fn register_python_bindings(hyperactor_mod: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    f.setattr(
        "__module__",
        "monarch.actor._extension.monarch_hyperactor.proc",
    )?;
