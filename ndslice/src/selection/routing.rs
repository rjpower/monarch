...
/// delivery.
#[cfg(test)]
pub(crate) struct RoutedMessage<T> {
    pub path: Vec<usize>,
...
// correctness.
#[cfg(test)]
pub(crate) fn collect_routed_paths(
    selection: &Selection,
    slice: &Slice,
...
#[cfg(test)]
pub(crate) fn collect_routed_nodes(selection: &Selection, slice: &Slice) -> Vec<usize> {
...
#[cfg(test)]
pub(crate) fn collect_commactor_routing_tree(
    selection: &Selection,
    slice: &Slice,
...
mod tests {
    ...
    use super::RoutedMessage;
    use super::RoutingAction;
    use super::RoutingFrame;
    use super::collect_commactor_routing_tree;
    use super::collect_routed_nodes;
